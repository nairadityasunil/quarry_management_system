            ...
            <div class="col-sm-10 d-flex flex-column">
                <div class="card" style="margin-top : 10px;">
                    <div class="card-body my-3 ">
                        <form action = "{{route('search_fuel_out_list')}}">
                                ...
                                <tbody>
                                    @foreach ($fuel_type as $fuel)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('update_fuel_out')}}/{{$fuel->id}}" class="btn btn-info">
                                            ...
                                            <td>
                                            <a href="{{url('print_fuel_out')}}/{{$fuel->id}}" class="btn btn-warning" target="_blank" rel="noopener noreferrer">
