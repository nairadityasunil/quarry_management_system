        ...
        <div class="col-sm-10" >
            <div class="card" style="margin-top :10px; height:95vh;">
                <div class="card-body overflow1 card-height" style="">
                    <h1 class="text-center">Fuel In</h1>
                    <br>
                    <form method="POST" action="{{route('save_fuel_in')}}" class="py-3">
                        @csrf
                        <div class="form-group row">
                            <label for="bill_no" class="col-sm-3 col-form-label">Bill No. :</label>
                            <div class="col-sm-6">
                                <input type="text" name="bill_no" class="form-control" id="bill_no" placeholder="" value="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select class="form-select" aria-label="Default select example" name="fuel_type">
                                    <option selected value="{{$fuel_name ?? '' }}">{{$fuel_name ?? '-'}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="quantity" class="form-control" id="quantity" placeholder="" value="{{$quantity ?? ''}}">
                                <span class="text-danger">
                                    @error('quantity')
                                        {{$message}}
                                    @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="rate" class="form-control" id="rate" placeholder="" value="">
                                <span class="text-danger">
                                    @error('rate')
                                        {{$message}}
                                    @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="amount" class="form-control" id="amount" placeholder="" value="" readonly="readonly">
                                <span class="text-danger">
                                    @error('amount')
                                        {{$message}}
                                    @enderror
