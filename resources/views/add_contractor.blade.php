        ...
        <div class="col-sm-10">
            <div class="card" style="margin-top :10px; height:95vh;">
                <div class="card-body overflow1 card-height" style="">
                    <h1 class="text-center">Add Contractor</h1>
                    <br>
                  
                    <form method="POST" action="{{route('store_contractor')}}" name="contractor_entry" class="py-3" enctype="multipart/form-data">
                        @csrf
                        <!-- <pre>
                            @php
                                print_r($errors->all());
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="contractor_name" class="form-control" id="contractor_name" placeholder=""  value="{{old('contractor_name')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="contractor_type" class="form-control" id="contractor_type" placeholder="" value="{{old('contractor_type')}}">
                                <span class="text-danger">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" id="address" rows="3" name="address" id="address"></textarea>
                                <span class="text-danger">
                                    @error('address')
                                        {{$message}}
                                    @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <button type="submit" class="btn btn-danger">Add Contractor</button>
                            </div>
                        </div>
                        <br>
                    </form>
