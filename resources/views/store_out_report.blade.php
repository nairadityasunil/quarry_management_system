                    ...
                    <div class="row">
                        <div class="col-sm-7 py-4 d-flex justify-content-end">
                         ...
                         <div class="col-sm-5 py-4">
                             <a href="{{route('download_store_out_pdf')}}" class="btn btn-primary">
                                 <!-- <button > -->
                                    Download Pdf
                                 <!-- </button> -->
                             </a>
                             <a href="{{route('download_store_out_excel')}}">
                                <button class="btn btn-danger">
                                    Download Excel
                                </button>
                             </a>
                             <a href="{{route('mail_store_out_pdf')}}">
                                <button class="btn btn-success">
                                    Mail Pdf
                                </button>
                             </a>
                             <a href="{{route('mail_store_out_excel')}}">
