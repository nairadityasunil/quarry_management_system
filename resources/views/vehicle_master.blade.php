            ...
            <div class="col-sm-10 d-flex flex-column">
                <div class="card" style="margin-top : 10px;">
                    <div class="card-body my-3">
                        <form action="{{route('search_vehicle')}}">
                            @csrf
                            <div class="form-group row">
                                <label for="search_item" class="col-sm-2 col-form-label">Vehicle Number :</label>
                                <div class="col-sm-6">
                    ...
                    <tbody>
                        @foreach ($all_vehicles as $vehicles)
                            <tr>
                                ...
                                <td>{{ $vehicles->loading_capacity }}</td>
                                <td>{{ $vehicles->tare_weight }}</td> 
                                <td>{{ $vehicles->driver_name }}</td>
                                <td>{{ $vehicles->license_no }}</td>
                                <td>{{ $vehicles->group }}</td>
                                <td>
                                    <a href="{{url('update_vehicle')}}/{{$vehicles->id}}" class="btn btn-info">
                                ...
                                <td>
                                    <a href="{{url('vehicle_delete')}}/{{$vehicles->id}}" class="btn btn-danger ">
        ...
        <table class="table table-bordered border-dark text-center">
            ...
            @foreach ($all_vehicles as $vehicles)
                    <tr>
                        <td>{{ $vehicles->id }}</td>
                        <td>{{ $vehicles->vehicle_no }}</td>
                        <td>{{ $vehicles->registered_owner }}</td>
                        <td>{{ $vehicles->loading_capacity }}</td>
                        <td>{{ $vehicles->tare_weight }}</td> 
                        <td>{{ $vehicles->make }}</td>
                        <td>{{ $vehicles->model_no }}</td>
                        <td>{{ $vehicles->engine_no }}</td>
                        <td>{{ $vehicles->chassis_no }}</td>
                        <td>{{ $vehicles->passing_territory }}</td>
                        <td>{{ $vehicles->fitness_upto }}</td>
                        <td>{{ $vehicles->permit_upto }}</td>
                        <td>{{ $vehicles->driver_name }}</td>
                        <td>{{ $vehicles->license_no }}</td>
                        <td>{{ $vehicles->group }}</td>
                        <td>
                            <a href="{{url('update_vehicle')}}/{{$vehicles->id}}">
                                <button class="btn btn-success">Update</button>
                            </a>
                        </td>
                        <td>
                            <a href="{{url('vehicle_delete')}}/{{$vehicles->id}}">
                                <button class="btn btn-danger">Delete</button>
                            </a>
                        </td>
                    </tr>
