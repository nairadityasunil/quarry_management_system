            ...
            <div class="col-sm-10 d-flex flex-column">
                <div class="card" style="margin-top : 10px;">
                    <div class="card-body my-3 ">
                        <form action = "{{route('search_store_in')}}">
                    ...
                    <div class="card-body overflow-auto" style="max-height:70vh;">
                        ...
                        <div class="container-fluid px-3 py-3" style="padding-right:10px;">
                            <table class="table table-bordered border-dark text-center">
                                ...
                                <tbody>
                                    @foreach ($store_in_list as $store_in)
                                        <tr>
                                            <td>{{ $store_in->id }}</td>
                                            ...
                                            <td>
                                            <a href="{{url('print_store_in')}}/{{$store_in->id}}" class="btn btn-warning" target="_blank" rel="noopener noreferrer">
