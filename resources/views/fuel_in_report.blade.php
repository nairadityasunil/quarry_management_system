                    ...
                    <div class="row">
                        <div class="col-sm-7 py-4 d-flex justify-content-end">
                         ...
                         <div class="col-sm-5 py-4">
                             <a href="{{route('download_fuel_in_pdf')}}" class="btn btn-primary">
                                 <!-- <button > -->
                                    Download Pdf
                                 <!-- </button> -->
                             </a>
                             <a href="{{route('download_fuel_in_excel')}}">
                                <button class="btn btn-danger">
                                    Download Excel
                                </button>
                             </a>
                             <a href="{{route('mail_fuel_in_pdf')}}">
                                <button class="btn btn-success">
                                    Mail Pdf
                                </button>
                             </a>
                             <a href="{{route('mail_fuel_in_excel')}}">
