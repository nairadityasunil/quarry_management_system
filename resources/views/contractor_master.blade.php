                                ...
                                <tbody>
                                    @foreach ($contractor_details as $contractor)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('update_contractor')}}/{{$contractor->id}}" class="btn btn-info">
                                            ...
                                            <td>
                                                <a href="{{url('delete_contractor')}}/{{$contractor->id}}" class="btn btn-danger">
                                            ...
                                            <td>
                                                <a href="{{url('print_contractor_details')}}/{{$contractor->id}}" class="btn btn-warning" target="_blank" rel="noopener noreferrer">
                                                <!-- <button class="btn btn-danger">Delete</button> -->
